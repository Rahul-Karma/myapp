$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','/staticresources/css/bootstrap-'+theme_name+'.css');
	}
...
function pageRequest(action, escapedKeyEqualsValueAmpersandString, owningDiv) {

	// this will use to display the result
	var resultDiv = $(owningDiv);

	$.ajax({
		type : "POST",
		url : action,
		data : escapedKeyEqualsValueAmpersandString,
