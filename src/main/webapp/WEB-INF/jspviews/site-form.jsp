			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						...
						<form:form class="form-horizontal" action="${addAction}" commandName="site">
						  <fieldset>
...
<!-- 							<div class="control-group">
							...
							<div class="control-group">
							  <label class="control-label" for="textarea2">Masthead</label>
							  <div class="controls">
								<textarea name="email" class="cleditor" id="textarea2" rows="3"></textarea>
							  </div>
							</div>
