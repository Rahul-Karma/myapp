      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#/setup/theme">Theme</a></li>
            <li><a href="#/setup/template">Templates</a></li>
            <li><a href="#/setup/page">Page Templates</a></li>
...
<!-- top nav ends  -->
  ...
  <div id="page-wrapper" ng-class="{'open': toggle}" ng-cloak>
    <!-- Sidebar -->
    <div id="sidebar-wrapper" scroll ui-view="sidebar">
